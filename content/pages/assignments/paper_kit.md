...
{{< resource bfbc2d43-6f7b-e381-212b-aa78b56ef5d1 "Photo of several LED devices." >}}
...
{{< resource 502ee9e6-320a-c38e-e84e-29258db8293f "Photo showing the front and back sides of the teardrop Arduino circuit board." >}}
...
{{< resource a3ad8718-e227-a697-cbc8-e1778190408e "Photo showing a pencil tracing the locations of holes in the tearDrop on a piece of paper." >}}
...
{{< resource e9184ea4-d9c5-fce8-92cc-34716d187f01 "Drawing of the tearDrop holes on paper, with two of them connected by a line." >}}
...
{{< resource 5b7438ad-ad92-ddeb-977d-58c2c001f9b7 "Photo of LED on paper." >}}

LED with bent legs glued to the paper.

Then paint over the legs of the LED with your conductive paint like so:

{{< resource f80a0965-6a60-22be-6710-4ed0bad6a4e4 "Photo of painted lines onto the LED leads." >}}

Conductive paint connecting to the LED leads.

{{< resource e72727ad-7dfb-92e3-9a40-408f12bf13f3 "Photo of the painted LED connection between two holes of the tearDrop template on paper." >}}
...
{{< resource f761b62f-4df2-d475-526f-2d316fa7bbb2 "Photo of a painted path for a switch." >}}

Adding a path for a switch made of painted paper.

{{< resource 59d7d58b-77f2-7754-6386-6e02787298a2 "Photo showing the LED lit up when the paper switch is closed." >}}
...
{{< resource 320ba03f-24b2-c479-5b02-0f77a530ae2a "Diagram illustrating the use of a variable graphite resistor connected to the tearDrop." >}}
...
{{< resource 5c125823-d7e2-a702-7458-99b521c01d3f "Photo of a paper sensor, using a semi-circle of graphite." >}}
